(() => {
    const aiAnswers = {
      en: {
        ...
        projects: "Mariam is currently developing four public projects: her Personal Website, Mariam AI, Rafeeq AI, and Step by Mira. All four continue to evolve while selected future ventures remain private.",
        ...
        hawat: "Hawat is a learning community in development. It is planned to launch at the beginning of the academic year and expand according to the Mariam Alharbi Foundation plan.",
        hawatHub: "Hawat Hub is the digital space being developed for the Hawat community. Its launch is planned for the beginning of the academic year, and it will expand according to the Mariam Alharbi Foundation plan. Preview: https://hwaat-hub.vercel.app",
      ...
      ar: {
        ...
        projects: "مريم تعمل حاليًا على أربعة مشاريع عامة قيد التطوير: موقعها الشخصي، وMariam AI، وRafeeq AI، وStep by Mira. تستمر المشاريع الأربعة في التطور، بينما تبقى المشاريع المستقبلية الأخرى خاصة.",
        ...
        hawat: "هواة مجتمع تعليمي قيد التطوير، ويُخطط لإطلاقه مع بداية العام الدراسي، ثم التوسع به وفق خطة مؤسسة مريم الحربي.",
        hawatHub: "هواة هب هو المساحة الرقمية الجاري تطويرها لمجتمع هواة. يُخطط لإطلاقه مع بداية العام الدراسي، ثم التوسع به وفق خطة مؤسسة مريم الحربي. يمكن استكشاف النسخة الحالية عبر https://hwaat-hub.vercel.app",
    ...
    const aiIntents = [
      ...
      { topic: "hawatHub", phrases: ["what is hawat hub", "tell me about hawat hub", "where can i find hawat hub", "is hawat hub live", "وش هواه هب", "وش هوات هب", "ايش هواه هب", "مشروع هواه هب", "هواه هب وش يقدم", "هل اطلق هواه هب", "وين القى هواه هب"], words: ["hawat hub", "hwaat hub", "هواه هب", "هوات هب", "هب هواه"] },
