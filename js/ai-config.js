(() => {
    const aiAnswers = {
      en: {
        ...
        projects: "Mariam is currently building her Personal Website, Mariam AI, Ruqi, Step by Mira, and Rafeeq AI as a prototype. Selected future ventures and vision concepts remain high-level while the ideas evolve.",
      ...
      ar: {
        ...
        projects: "مريم تشتغل حاليًا على موقعها الشخصي وMariam AI وRuqi وStep by Mira وRafeeq AI كنموذج أولي. تبقى المشاريع المستقبلية والمفاهيم الرؤيوية على مستوى عام أثناء تطور الأفكار.",
    ...
    const aiIntents = [
      ...
      { topic: "projects", phrases: ["what projects", "what are you building", "what are you working on", "working on these days", "وش مشاريعك", "وش المشاريع اللي تبنيها", "وش قاعده تبنين", "وش عندك حاليا", "وش تشتغلين عليه", "ايش مشاريعك", "وش ناويه تسوين", "وش تسوين"], words: ["projects", "project", "building", "ventures", "working on", "مشاريع", "مشروع", "تبنين", "تشتغلين", "ناويه", "عندك"] },
      ...
      { topic: "languages", phrases: ["what languages", "what languages do you speak", "وش لغاتك", "ايش اللغات اللي تعرفينها"], words: ["languages", "language", "لغات", "اللغه", "العربيه", "الانجليزيه", "الالمانيه"] },
